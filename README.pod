...
For full explanation of outthentic DSL please follow L<dumentation|https://github.com/melezhik/outthentic-dsl>.
...
swat modules have a variables hash passed into a module as third parameter of runI<swat>module function:
...
swat I<interpolate> module variables into `curl_params' variable in swat module story:
