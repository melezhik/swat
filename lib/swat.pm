...
C<swat_my> - sets alternative file path for swat.my configuration file; See L<alternative swat ini files locations|#alternative-swat-ini-files-locations> for the explanation of what is swat.my file.
